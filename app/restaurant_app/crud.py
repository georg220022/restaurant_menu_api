...
class CrudMenu:
    ...
    @staticmethod
    async def create_menu_db(data, asyn_db) -> dict:
        """Метод создания меню"""
    ...
    @staticmethod
    async def edit_menu_db(menu_id, data, asyn_db):
    ...
    @staticmethod
    async def delete_menu_db(menu_id, asyn_db):
        """Метод удаления меню"""
        try:
...
class CrudSubMenu:
    ...
    @staticmethod
    async def create_sub_menu_db(menu_id, data, asyn_db):
    ...
    @staticmethod
    async def edit_sub_menu_db(menu_id, sub_menu_id, data, asyn_db):
        """Метод редактирования подменю"""
        query = (
            sub_menus.update()
            .where(sub_menus.c.id == sub_menu_id)
            .values(title=data.title, description=data.description)
        )
        try:
            await asyn_db.execute(query)
    ...
    @staticmethod
    async def delete_sub_menu_db(menu_id, sub_menu_id, asyn_db):
        """Метод удаления подменю"""
        try:
            await asyn_db.execute(
                sub_menus.delete().where(sub_menus.c.id == sub_menu_id)
            )
            await asyn_db.commit()
        except PostgresError as exc:
            asyn_db.rollback()
...
class CrudDish:
    @staticmethod
    async def get_dish_db(menu_id, sub_menu_id, asyn_db, dish_id=None):
    ...
    @staticmethod
    async def create_dish_db(menu_id, sub_menu_id, data, asyn_db):
    ...
    @staticmethod
    async def edit_dish_db(menu_id, sub_menu_id, dish_id, data, asyn_db):
    ...
    @staticmethod
    async def delete_dish_db(menu_id, sub_menu_id, dish_id, asyn_db):
